<!-- Szablon odpowiadający za wyświetlanie formluarza pozwalającego na wyświetlanie historii auta -->
...
<form name="historia_auta">            
  <table>
    ...
    <tr><td><span id="data"><input type="button" value="Sprawdź" onclick="hist_auta()" /></span></td>
